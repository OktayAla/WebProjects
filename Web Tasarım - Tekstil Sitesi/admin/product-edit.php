...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $products_data[$new_category][] = $updated_product;
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="features" name="features" rows="4" required><?php echo json_encode($product['features'], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE); ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="category" class="form-label">Kategori</label>
                        <select class="form-control" id="category" name="category" required>
                            <?php foreach ($categories as $category): ?>
                                <option value="<?php echo htmlspecialchars($category); ?>" <?php echo $category == $product['category'] ? 'selected' : ''; ?>>
