        ...
        <div class="hero-content">
            ...
            <div class="hero-stats">
                <div class="stat-item">
                    ...
                    <span>MÖ 1. yüzyıl</span>
                </div>
                <div class="stat-item">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>Arpaçay, Kars</span>
                </div>
                <div class="stat-item">
                    <i class="fas fa-ruler-combined"></i>
                    <span>85 Hektar Alan</span>
                </div>
            </div>
        </div>
    ...
    <div class="detail-content">
        <div class="content-wrapper">
            ...
            <section class="architecture-section">
                ...
                <ul>
                    <li>Ani Katedrali (Fethiye Camii)</li>
                    <li>Tigran Honents Kilisesi</li>
                    <li>Menüçehr Camii</li>
                    <li>Surlar ve Burçlar</li>
                    <li>Gagik Kilisesi</li>
                    <li>Büyük Hamam</li>
                    <li>Selçuklu Sarayı</li>
                    <li>İpek Yolu Köprüsü</li>
                    <li>Yeraltı Şehri</li>
                </ul>
            </section>
            ...
            <section class="visiting-info">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        <h3>Ulaşım</h3>
                        <ul>
                            <li>Kars şehir merkezine 42 km</li>
                            <li>Kars Havalimanı'na 55 km</li>
                            <li>Özel araç tavsiye edilir</li>
                            <li>Tur operatörleri hizmetleri</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <ul>
                            ...
                            <li>Kış: 08:00-17:00</li>
                            <li>Her gün açık</li>
                            <li>En ideal ziyaret: İlkbahar-Sonbahar</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-card">
                        <h3>Öneriler</h3>
                        <ul>
                            <li>Rehberli tur önerilir</li>
                            <li>Rahat yürüyüş ayakkabısı</li>
                            <li>Şapka ve güneş kremi</li>
                            <li>Su ve atıştırmalık</li>
