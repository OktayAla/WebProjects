...
<main class="detail-page">
    <div class="detail-hero">
        ...
        <div class="hero-content">
            ...
            <p class="hero-description">Ankara'nın tarihine tanıklık eden, şehre hakim konumuyla göz alıcı kale</p>
            <div class="hero-stats">
                <div class="stat-item">
                    <i class="fas fa-calendar-alt"></i>
                    <span>MS 7. yüzyıl</span>
                </div>
                <div class="stat-item">
                    <i class="fas fa-map-marker-alt"></i>
                    <span>Altındağ, Ankara</span>
                </div>
                <div class="stat-item">
                    <i class="fas fa-mountain"></i>
                    <span>Rakım: 978m</span>
                </div>
            </div>
        </div>
    ...
    <div class="detail-content">
        <div class="content-wrapper">
            ...
            <section class="architecture-section">
                ...
                <ul>
                    <li>Toplam 20 burç ve 40 kule</li>
                    <li>İç ve dış kale bölümleri</li>
                    <li>Yaklaşık 43.000 m²'lik alan</li>
                    <li>Bizans ve Roma dönemi mimari özellikleri</li>
                    <li>Kesme taş ve devşirme malzeme kullanımı</li>
                    <li>Şehre hakim stratejik konum</li>
                    <li>Tarihi sur duvarları</li>
                    <li>Geleneksel Ankara evleri</li>
                </ul>
            </section>
            ...
            <section class="visiting-info">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        <h3>Ulaşım</h3>
                        <ul>
                            <li>Ulus Meydanı'na yürüme mesafesinde</li>
                            <li>Ankaray - Ulus İstasyonu</li>
                            <li>Belediye otobüsleri</li>
                            <li>Dolmuş hatları</li>
                        </ul>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <ul>
                            <li>24 saat açık (Dış alan)</li>
                            <li>Dükkânlar: 09:00-19:00</li>
                            <li>Restoranlar: 10:00-23:00</li>
                            <li>Her mevsim ziyaret edilebilir</li>
                        </ul>
                    </div>

                    <div class="info-card">
                        <h3>İmkanlar ve Aktiviteler</h3>
                        <ul>
                            <li>Panoramik Ankara manzarası</li>
                            <li>Geleneksel el sanatları dükkânları</li>
                            <li>Yerel restoranlar</li>
                            <li>Fotoğraf çekim noktaları</li>
                            <li>Tarihi sokaklar</li>
                            <li>Hediyelik eşya dükkânları</li>
                        </ul>
                    </div>
                </div>
            </section>
