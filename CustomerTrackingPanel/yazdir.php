		...
		<div class="receipt">
			<div class="receipt-header">
				...
				<div class="receipt-header-content">
					<h1 id="company-name-display" class="receipt-title mb-1">ANALİZ TARIM</h1>
					<div id="company-contact-display" class="text-xs text-gray-600 mb-2"></div>
					<h2 class="receipt-title text-sm mb-2"><?php echo $tx['odeme_tipi'] === 'borc' ? 'BORÇ DEKONTU' : 'TAHSİLAT DEKONTU'; ?></h2>
					<div class="text-xs">Fiş No: #<?php echo $tx['id']; ?> | Tarih: <?php echo date('d.m.Y H:i', strtotime($tx['olusturma_zamani'])); ?></div>
				</div>
			</div>
			<div class="panel">
