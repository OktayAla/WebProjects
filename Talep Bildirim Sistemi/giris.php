...
if (isset($_SESSION['user_id'])) {
    header("Location: talepbildirim.php");
    exit;
}
...
// Karakter kodlamasını utf8mb4 olarak ayarla
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, sifre FROM kullanicilar WHERE kullanici_adi = ? AND rol = 'kullanici'";
    ...
    if ($id) {
        ...
        $error_message = "Kullanıcı adı veya şifre hatalı! <br>
        Şifrenizi unuttuysanız lütfen Bilgi İşlem ile iletişime geçiniz.";
    }
    $stmt->close();
}
?>
...
<body>
    <div class="container">
        <a href="https://test.kodkampusu.com/talepbildirimsistemi/" target="_blank">
            <img src="https://www.kodkampusu.com/wp-content/uploads/2020/12/yenilogo.png" alt="logo" class="logo"
                id="logo">
        </a>
        <p class="baslik">Kullanıcı Girişi</p>
    ...
    <script>
        ...
        logo.addEventListener('mousemove', (e) => {
            ...
            logo.style.transform = `rotateY(${x * 30}deg) rotateX(${y * -30}deg) translateZ(50px)`;
            /* Daha belirgin hareket */
        });
