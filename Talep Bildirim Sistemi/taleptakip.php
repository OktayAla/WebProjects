...
// Fonksiyon: Tüm veriyi Excel formatına dönüştür
function prepareExcelData($conn, $sql) {
...
// Excel'e aktarma isteği geldi mi?
if (isset($_GET['excel']) && $_GET['excel'] == 'true') {
    // Sayfalama olmadan, tüm veriyi al
    $excel_data = prepareExcelData($conn, $sql);

    // Veriyi JSON formatına dönüştür ve çıktısını al
    header('Content-Type: application/json');
    echo json_encode($excel_data, JSON_UNESCAPED_UNICODE);
    exit; // Script'i burada sonlandır
} else {
    // Sayfalama işlemleri (mevcut kodunuz)
    // ...
...
<head>
    ...
    <title>Bildirilen Tüm Talepler</title>
...
<body>
    <div class="top-menu">
        <div class="menu-container">
            ...
            <a href="#" class="menu-button" id="excelAktarButon">
    ...
    <div class="container">
        <h1 class="baslik">Bildirilen Tüm Talepler</h1>
            ...
            <form method="POST" class="arama-form">
                ...
                <div class="form-group">
                    ...
                    <select id="personelBirimi" name="personelBirimi">
                        ...
                        <option value="Atakent Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Atakent Mahallesi' ? 'selected' : ''; ?>>Atakent Mahallesi</option>
                        <option value="Aydoğdu Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Aydoğdu Mahallesi' ? 'selected' : ''; ?>>Aydoğdu Mahallesi</option>
                        <option value="Bağcağız Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Bağcağız Mahallesi' ? 'selected' : ''; ?>>Bağcağız Mahallesi</option>
                        <option value="Bahçeköy Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Bahçeköy Mahallesi' ? 'selected' : ''; ?>>Bahçeköy Mahallesi</option>
                        ...
                        <option value="Cumhuriyet Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Cumhuriyet Mahallesi' ? 'selected' : ''; ?>>Cumhuriyet Mahallesi</option>
                        <option value="Çaltılı Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Çaltılı Mahallesi' ? 'selected' : ''; ?>>Çaltılı Mahallesi</option>
                        <option value="Çamlıca Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Çamlıca Mahallesi' ? 'selected' : ''; ?>>Çamlıca Mahallesi</option>
                        <option value="Çınarlı Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Çınarlı Mahallesi' ? 'selected' : ''; ?>>Çınarlı Mahallesi</option>
                        ...
                        <option value="Değirmenli Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Değirmenli Mahallesi' ? 'selected' : ''; ?>>Değirmenli Mahallesi</option>
                        <option value="Dereköy Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Dereköy Mahallesi' ? 'selected' : ''; ?>>Dereköy Mahallesi</option>
                        ...
                        <option value="Güzelköy Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Güzelköy Mahallesi' ? 'selected' : ''; ?>>Güzelköy Mahallesi</option>
                        ...
                        <option value="İstiklal Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'İstiklal Mahallesi' ? 'selected' : ''; ?>>İstiklal Mahallesi</option>
                        <option value="Karaağaç Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Karaağaç Mahallesi' ? 'selected' : ''; ?>>Karaağaç Mahallesi</option>
                        <option value="Kavaklı Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Kavaklı Mahallesi' ? 'selected' : ''; ?>>Kavaklı Mahallesi</option>
                        ...
                        <option value="Köselerli Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Köselerli Mahallesi' ? 'selected' : ''; ?>>Köselerli Mahallesi</option>
                        ...
                        <option value="Küçük Köy Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Küçük Köy Mahallesi' ? 'selected' : ''; ?>>Küçük Köy Mahallesi</option>
                        <option value="Merkez Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'MerkezMahallesi' ? 'selected' : ''; ?>>Merkez Mahallesi</option>
                        ...
                        <option value="Ortaören Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Ortaören Mahallesi' ? 'selected' : ''; ?>>Ortaören Mahallesi</option>
                        ...
                        <option value="Pınarbaşı Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Pınarbaşı Mahallesi' ? 'selected' : ''; ?>>Pınarbaşı Mahallesi</option>
                        <option value="Sarıkavak Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Sarıkavak Mahallesi' ? 'selected' : ''; ?>>Sarıkavak Mahallesi</option>
                        <option value="Selamlı Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Selamlı Mahallesi' ? 'selected' : ''; ?>>Selamlı Mahallesi</option>
                        ...
                        <option value="Yalnızcabağ Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Yalnızcabağ Mahallesi' ? 'selected' : ''; ?>>Yalnızcabağ Mahallesi</option>
                        <option value="Yeniköy Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Yeniköy Mahallesi' ? 'selected' : ''; ?>>Yeniköy Mahallesi</option>
                        <option value="Yeşilyurt Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Yeşilyurt Mahallesi' ? 'selected' : ''; ?>>Yeşilyurt Mahallesi</option>
                        <option value="Yukarıköselerli Mahallesi" <?php echo isset($_POST['personelBirimi']) && $_POST['personelBirimi'] == 'Yukarıköselerli Mahallesi' ? 'selected' : ''; ?>>Yukarıköselerli Mahallesi</option>
                    </select>
                </div>
        ...
        <!-- Arıza Bildirimlerini Gösteriyoruz -->
        <div class="bildirimler-container">
            <?php
             // Yeni bir sorgu çalıştır
            $result_for_display = $conn->query($sql_for_display);

            // Veritabanından gelen her bildirimi listele
            if ($result_for_display->num_rows > 0) {
                while ($row = $result_for_display->fetch_assoc()) {
                    $tarihSaat = date('d.m.Y H:i', strtotime($row['tarih_saat']));
                    echo "<div class='bildirim'>
                            <p><strong>Tarih ve Saat:</strong> $tarihSaat</p>
                            <p><strong>Talep Eden Kişi:</strong> " . htmlspecialchars($row['personel_adi'] ?? '') . "</p>
                            <p><strong>Mahalle:</strong> " . htmlspecialchars($row['personel_birimi'] ?? '') . "</p>
                            <p><strong>Talep Edilen Birim:</strong> " . htmlspecialchars($row['talep_turu'] ?? '') . "</p>
                            <p><strong>Talep Numarası:</strong> " . htmlspecialchars($row['id'] ?? '') . "</p>
                            <p><strong>Talep Detayı:</strong> " . htmlspecialchars($row['detay'] ?? '') . "</p>
                            <p><strong>Durum:</strong> <span class='durum-badge durum-" . strtolower(str_replace(
                                ['İ', 'ı', 'Ğ', 'ğ', 'Ü', 'ü', 'Ş', 'ş', 'Ö', 'ö', 'Ç', 'ç', ' ', '-'],
                                ['i', 'i', 'g', 'g', 'u', 'u', 's', 's', 'o', 'o', 'c', 'c', '-', '-'],
                                $row['durum'] ?? ''
                            )) . "'>" . htmlspecialchars($row['durum'] ?? '') . "</span></p>
                        </div>";
                }
            } else {
                echo "<p>Aradığınız kriterlere uygun bir talep bildirimi bulunamadı.</p>";
                echo "<p>Lütfen farklı kriterlerle tekrar deneyiniz.</p>";
            }
            ?>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const excelAktarButon = document.getElementById('excelAktarButon');

            excelAktarButon.addEventListener('click', function (e) {
                e.preventDefault(); // Linkin varsayılan davranışını engelle

                // Filtre değerlerini al
                let personelAdi = document.getElementById('personelAdi').value;
                let personelBirimi = document.getElementById('personelBirimi').value;
                let talepTuru = document.getElementById('talepTuru').value;
                let durum = document.getElementById('durum').value;

                // URL'yi oluştur
                let url = 'taleptakip.php?excel=true';
                if (personelAdi) {
                    url += '&personelAdi=' + encodeURIComponent(personelAdi);
                }
                if (personelBirimi) {
                    url += '&personelBirimi=' + encodeURIComponent(personelBirimi);
                }
                if (talepTuru) {
                    url += '&talepTuru=' + encodeURIComponent(talepTuru);
                }
                if (durum) {
                    url += '&durum=' + encodeURIComponent(durum);
                }

                // Tüm veriyi almak için AJAX isteği gönder
                fetch(url, {
                    method: 'GET',
                })
                ...
                .then(jsonData => {
                    // Başlıkları tanımla
                    const basliklar = ['Talep Numarası','Tarih ve Saat', 'Talep Eden Kişi', 'Mahalle', 'Talep Edilen Birim', 'Talep Detayı', 'Durum'];

                    // Veriyi çalışma sayfasına dönüştür
                    const worksheet = XLSX.utils.json_to_sheet(jsonData, { header: basliklar });
                    ...
                    // Başlık hücrelerine stili uygula
                    for (let i = 0; i < basliklar.length; i++) {
                        const cellAddress = XLSX.utils.encode_cell({ r: 0, c: i });
                        if (worksheet[cellAddress]) {
                            worksheet[cellAddress].s = baslikStili;
                        }
                    }

                    // Sütun genişliklerini ayarla
                    const colWidths = [
                        { wch: 12 }, // Talep Numarası
                        { wch: 15 }, // Tarih ve Saat
                        { wch: 25 }, // Talep Eden Kişi
                        { wch: 20 }, // Mahalle
                        { wch: 40 }, // Talep Edilen Birim
                        { wch: 50 }, // Talep Detayı
                        { wch: 15 }  // Durum
                    ];
